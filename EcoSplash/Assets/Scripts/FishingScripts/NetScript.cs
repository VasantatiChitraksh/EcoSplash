...
//     private int totalGarbage; // Total number of garbage objects
//     private int collectedGarbage = 0; // Counter for collected garbage objects

//     void Start()
//     {
//         // Count all garbage objects in the scene at the start
//         totalGarbage = GameObject.FindGameObjectsWithTag("Garbage").Length;
//     }
...
//                 // Check if all garbage is collected
